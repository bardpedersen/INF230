...
--@block Task 4
SELECT * FROM Products WHERE UnitPrice < 10 AND QuantityPerUnit <> '12 - 12 oz cans' ORDER BY ProductName DESC;

--@block Task 5
SELECT ProductName, SupplierID, UnitPrice FROM Products ORDER BY SupplierID DESC, UnitPrice;
...
--@block Task 9
UPDATE departments SET ManagerID = 40 WHERE DepartmentName = 'Marketing';

--@block Task 10
UPDATE departments SET DepartmentName = NULL WHERE ManagerID = 14;
